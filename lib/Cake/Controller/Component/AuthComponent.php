...
class AuthComponent extends Component {
    ...
    protected function _setDefaults() {
        $defaults = array(
            ...
            'authError' => __d('cake', '<div class="row">
                                <div class="small-10 medium-10 large-10 small-centered medium-centered large-centered columns">
                                     <div data-alert class="alert-box warning radius">Vous n\'êtes pas autorisé à accéder à cette ressource.<a href="#" class="close">&times;</a>
                                </div>
                                </div>
                                </div>') //#MODIF DE TIMOTHEE. ORIGINAL : 'You are not authorized to access that location.'
        );
