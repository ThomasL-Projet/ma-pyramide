<div id="presentation">
    ...
    <div class="texte">
        ...
        <div class="span2"> Mon suivi alimentaire </div> 

        <div class="p1">Recherchez dans l'encyclopédie et ajoutez les aliments afin de vérifier si vos choix correspondent aux valeurs personnalisées des groupes alimentaires.
            Simplifiez cette étape en utilisant « mes aliments favoris » . <br><br>
            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSi vous voulez voir, modifier ou supprimer vos aliments consommés dans la journée <strong><?php echo $this->Html->link('Cliquez ici', '/suivialimentaires/edit/', array('escape' => false, 'title' => 'Voir mes aliments')); ?></strong>
        </div>
    </div>
    <div id="bloc-editeur" style="margin-top:30px">
        <center><h1 style="color:#A6BC2A;">Navigation</h1></center><br /><hr /><br />
        <input type="button" style="margin:0px; width:170px" value="Suivi alimentaire" onclick="clicBouton1()" />
        <input type="button" style="margin:0px; width:170px; margin-left:10px;" value="Rechercher un aliment" onclick="clicBouton2()" />
        <input type="button" style="margin:0px; width:170px; margin-left:10px;" value="Mes aliments" onclick="clicBouton3()" />
        <input type="button" style="margin:0px; width:170px; margin-left:10px;" value="Récapitulatif repas" onclick="clicBouton4()" />
    </div><br />
    <div class = "suiviresume" style="margin-top: 500px" >
...
<?php echo $obPoi ?></i></p>
        ...
        <div class ="reste">
            ...
            <p class = "pluslong"><?php echo $restecal ?></p>
            <p class = "pluslong"><?php echo $resteJ ?></p>
            <p><?php echo $restepro ?></p>
            <p><?php echo $restelip ?></p>
            <p><?php echo $resteglu ?></p>
            <p><?php echo $resteeau ?></p>
            <p><?php echo $restefib ?></p>
            <p><?php echo $restesel ?></p>
            <p></p>
        </div>
    ...
    <div id="deuxiemeencyclo">
        <div id="presentation">
            ...
            <div id="titre-accueil">
                <p>Ajoutez des aliments à votre suivi</p><br><br>
                <p id="lab1">type :</p>
...
<?php if (isset($user) AND ! empty($user['Alimentfavori'])) : ?>
                <input style="margin-left:100px; margin-top: 205px;position:absolute; width:169px" type="submit" name="alifav" value="Mes aliments favoris" />	
<?php endif; ?>
        ...
        <!-- <div id="lien-accueil">
            ...
            <div id="encyclo" style="margin-top:-80px">
                <?php
...
<?php echo $this->Html->link('<input type="button" style="margin:0px;margin-left:300px;width: 150px" name="modif" value="Gérer mes aliments" >', '/suivialimentaires/edit/', array('escape' => false, 'title' => 'Gérer mes aliments')); ?>
            </center>
        </div>
    </div>
</form>
