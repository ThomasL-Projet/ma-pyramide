...
echo $this->Form->create('Suivialimentaire');
  ?>
<div class="span2"> Modifiez votre repas </div> 
	<div class="bloc1">
	<?php 
		...
		if (isset($aliment['Aliment'])) echo "<h3>".$this->Html->link($aliment['Aliment']['nomFR'], '../app/webroot/img/imagesAliment/' . $fichier, array('class' => 'zoombox', 'alt' => $aliment['Aliment']['nomFR'], 'escape' => true)) ."</h2>";
		else echo "<h3>".$aliment['Alimhorsclassification']['nom']."</h2>";
	?>
	...
	<input type="submit" value="Valider" onClick="return confirm();">
