<?php
// titre de la page
$this->assign('title', 'Ma Pyramide Santé - Ajouter un aliment à un de vos repas');
?>
<nav class="breadcrumbs" role="menubar" aria-label="breadcrumbs">
    ...
    <li role="menuitem"><?php echo $this->Html->link('Aliments hors classification', ['controller' => 'alimenthorsclassification', 'action' => 'index', 'full_base' => true]); ?></li>
    <li role="menuitem" class="current"><?php echo $this->Html->link('Ajout d\'aliments hors classification', 'Javascript:void(0);'); ?></li>
</nav>
<?php
...
<div id="presentation">
    <div class="row">
        <div class="small-12 small-centered columns">
            <div class="title-area"> Ajout d'aliments hors classification </div> 

            <div class="textarea">
                <p class="text-justify">
                    Informations concernant l'aliment.
                </p>			
            </div>
        </div>
    </div> 
    <div class="row">
        <div class="small-12 columns">
            ...
            <div id="bloc-editeur">
                ...
                <input type="text" maxlength="50" id="saisie1" value="<?php if (isset($alimhorsclass)) echo $alimhorsclass['Alimhorsclassification']['nom']; ?>" required="required" name="data[Mesrecette][nom]" /><br/>
                <p> Origine de l'aliment :</p>
                <input type="text" maxlength="50" id="saisie2" value="<?php if (isset($alimhorsclass)) echo $alimhorsclass['Alimhorsclassification']['origine']; ?>" required="required" name="data[Mesrecette][origine]" /><br/>
                <p> Portion de l'aliment (en g) :</p>
                <input type="text" maxlength="5" id="saisie3" value="<?php if (isset($alimhorsclass))
    echo $alimhorsclass['Alimhorsclassification']['portion'];
else
    echo '100';
?>" required="required" name="data[Mesrecette][portion]" onchange="changePortion()" /><br/>
                <p> Description :</p>
                <textarea  id="saisie4" rows="6" cols="70" name="data[Mesrecette][description]" title="La description doit faire entre 1 et 500 caractètres" maxlength="500"><?php if (isset($alimhorsclass)) echo $alimhorsclass['Alimhorsclassification']['description']; ?></textarea><br/>
                <hr />
...
<?php
if (isset($alimhorsclass['Alimhorsingrediant'])) {
    $i = 0;
                ...
                <div id="affichrec">
                    <table style="width:750px">
                        <tr>
                            ...
                            <td width=25% id="descriport"><strong>Valeur pour <?php if (isset($alimhorsclass))
    echo $alimhorsclass['Alimhorsclassification']['portion'];
else
    echo '100';
?>g</td>
...
<?php for ($j = 0; $j < 57; $j++) : ?>
                            <tr>
                                ...
                                <td><input style="width:70px; margin-left:45px; margin-top:10px; margin-bottom:10px" type="text" maxlength="6" id="nutri<?php echo $j; ?>" value="<?php if (isset($nutri))
        echo $nutri[$j];
    else
        echo '0';
    ?>" name="Nutri[<?php echo $j; ?>]" onchange="actuVals(<?php echo $j; ?>)" /></td>
                                <td>
                                    <div style="font-style:italic" id="nutrival<?php echo $j; ?>"><?php if (isset($alimhorsclass))
        echo $nutri[$j] * $alimhorsclass['Alimhorsclassification']['portion'] / 100;
    else
        echo '0';
    ?></div>
                                </td>
...
<?php endfor; ?>
                ...
                <input class="button" type="submit" id="endform" name="endform" value="Ajouter l'aliment" onclick="return validForm();" /><br>
...
<script type="text/javascript">
    var i = <?php if (isset($i))
    echo $i;
else
    echo '0';
?>;
    var basei = <?php if (isset($i))
    echo $i;
else
    echo '0';
?>;
    var baseQuantite = <?php if (isset($alimhorsclass))
    echo $alimhorsclass['Alimhorsclassification']['portion'];
else
    echo '100';
?>;
    function addLigne() {
        ...
        newCell.innerHTML = '<input type="text" maxlength="3" id="alimqua' + i + '" name="Ingrediant[' + i + '][quantite]" /><div >%</div></td></tr>';
    }
