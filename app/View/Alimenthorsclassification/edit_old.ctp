...
<div id="bloc-editeur">
	...
	<input style="margin-left:220px" type="text" maxlength="50" id="saisie1" value="<?php echo $alimhorsclass['Alimhorsclassification']['nom']; ?>" required="required" name="data[Mesrecette][nom]" /><br><br><br>
	<div style="margin-bottom:-30px;"><p> Origine de l'aliment :</p></div>
	<input style="margin-left:220px" type="text" maxlength="50" id="saisie2" value="<?php echo $alimhorsclass['Alimhorsclassification']['origine']; ?>" required="required" name="data[Mesrecette][origine]" /><br><br><br>
	<div style="margin-bottom:-30px;"><p> Portion de l'aliment (en g) :</p></div>
	<input style="margin-left:220px" type="text" maxlength="5" id="saisie3" value="<?php echo $alimhorsclass['Alimhorsclassification']['portion']; ?>" required="required" name="data[Mesrecette][portion]" onchange="changePortion()" /><br><br><br>
	<div style="margin-bottom:-30px;"><p> Description :</p></div>
	<textarea style="margin-left:220px; width:530px" id="saisie4" rows="6" cols="70" name="data[Mesrecette][description]" title="La description doit faire entre 1 et 500 caractètres" maxlength="500"><?php echo $alimhorsclass['Alimhorsclassification']['description']; ?></textarea><br><br><br>
	<hr />
	...
	<?php $i = 0; foreach ($alimhorsclass['Alimhorsingrediant'] as $alim) : ?>
	<tr>
		<td>
	...
	<input style="margin:0px;alter:left; width:180px; margin-left:70px" type="submit" id="endform" name="endform" value="Modifier l'aliment" onclick="return validForm();" /><br>
