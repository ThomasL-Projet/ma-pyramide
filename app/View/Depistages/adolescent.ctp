<?php
// titre de la page
$this->assign('title', 'Ma Pyramide Santé - Dépistage adolescent');
?>
<style>
...
<nav class="breadcrumbs" role="menubar" aria-label="breadcrumbs">
    ...
    <li role="menuitem" class="current"><?php echo $this->Html->link('Dépistage adolescent', 'Javascript:void(0);'); ?></li>
</nav>
<div id="presentation">
    <div class="row">
        <div class="small-12 columns">
            ...
            <center><h1> Dépistages du microbiote - Adolescent</h1></center>
            ...
            <input name="q1" class="element radio" type="radio" value="1-0" checked/>
            <label>Jamais</label><br/>
            <input name="q1" class="element radio" type="radio" value="2-1" />
            <label>Une fois</label><br/>
            <input  name="q1" class="element radio" type="radio" value="3-2" />
            <label>Plus d'une fois</label><br/>

            <br/><hr/><br/>

            <label >Pendant la grossesse ; la maman était en contact avec des animaux domestiques </label><br/>

            <input name="q2" class="element radio" type="radio" value="1-0" checked/>
            <label>Oui</label><br/>
            <input name="q2" class="element radio" type="radio" value="2-1" />
            <label>Non</label><br/>
            ...
            <input name="q3" class="element radio" type="radio" value="2-2" />
            <label>Prématuré</label><br/>
            <input  name="q3" class="element radio" type="radio" value="3-1" />
            ...
            <input name="q5" class="element radio" type="radio" value="3-1" />
            <label>Avec les deux</label><br/>

            <br/><hr/><br/>
            <label>Le bébé a été allaité</label><br/>

            <input name="q6" class="element radio" type="radio" value="1-1" checked/>
            <label>Pendant 1 mois</label><br/>
            <input name="q6" class="element radio" type="radio" value="2-1" />
            <label>Pendant 2 mois</label><br/>
            <input  name="q6" class="element radio" type="radio" value="3-0" />
            <label>Pendant 3 mois</label><br/>
            <input  name="q6" class="element radio" type="radio" value="4-0" />
            <label>Pendant 6 mois</label><br/>
            <input  name="q6" class="element radio" type="radio" value="5-0" />
            ...
            <input name="q7" class="element radio" type="radio" value="2-2" />
            <label>Le bébé a consommé plus tôt des petits pots du commerce</label><br/>
            <input  name="q7" class="element radio" type="radio" value="3-1" />
            ...
            <label>Jamais</label><br/>
            <input name="q8" class="element radio" type="radio" value="2-0" />
            <label>Quelques fois</label><br/>
            <input  name="q8" class="element radio" type="radio" value="3-2" />
            <label>Souvent</label><br/>

            <br/><hr/><br/>
            <label>Mon ado mange régulièrement des produits céréaliers </label><br/>

            <input name="q9" class="element radio" type="radio" value="1-1" checked/>
            <label>Plus de 5 fois par jour</label><br/>
            <input name="q9" class="element radio" type="radio" value="2-0" />
            <label>4 à 5 fois par jour</label><br/>
            <input  name="q9" class="element radio" type="radio" value="3-0" />
            <label>3  à 4 fois par jour</label><br/>
            <input  name="q9" class="element radio" type="radio" value="4-1" />
            <label>Moins de deux fois par jour</label><br/>

            <br/><hr/><br/>
            <label>Mon ado mange régulièrement des produits laitiers</label><br/>

            <input name="q10" class="element radio" type="radio" value="1-0" checked/>
            ...
            <input  name="q10" class="element radio" type="radio" value="3-1" />
            <label>2 fois par jour</label><br/>
            <input  name="q10" class="element radio" type="radio" value="4-2" />
            <label>Moins de une fois par jour</label><br/>

            <br/><hr/><br/>
            <label>Mon ado mange régulièrement des fruits </label><br/>
            ...
            <input  name="q11" class="element radio" type="radio" value="5-3" />
            <label>Jamais</label><br/>
            
            <br/><hr/><br/>
            <label>Mon ado mange régulièrement des légumes </label><br/>
            ...
            <br/><hr/><br/>
            <label>Mon ado mange régulièrement de la viande, poisson, volaille, oeufs ...</label><br/>
            ...
            <br/><hr/><br/>
            <label>Mon ado mange au fast food </label><br/>
            ...
            <br/><hr/><br/>
            <label>Mon ado boit régulièrement des jus ou des boissons aromatisés</label><br/>
            ...
            <br/><hr/><br/>
            <label>Mon ado mâche ses aliments avec difficulté, avale de travers ou s'étouffe </label><br/>
            ...
            <br/><hr/><br/>
            <label>Mon ado a faim au moment des repas</label><br/>
            ...
            <br/><hr/><br/>
            <label>Mon ado mange régulièrement</label><br/>

            <input name="q19" class="element radio" type="radio" value="1-3" checked/>
            <label>Moins de 2 fois par jour</label><br/>
            <input name="q19" class="element radio" type="radio" value="2-2" />
            <label>2 fois par jour</label><br/>
            <input  name="q19" class="element radio" type="radio" value="3-0" />
            <label>3 à 4 fois par jour</label><br/>
            <input  name="q19" class="element radio" type="radio" value="4-0" />
            <label>4 à 5 fois par jour</label><br/>
            <input  name="q19" class="element radio" type="radio" value="5-0" />
            <label>Plus de 6 fois par jour</label><br/>

            <br/><hr/><br/>
            <label>Mon ado décide lui-même de la quantité qu'il mange</label><br/>
            ...
            if (isset($resultat) && $resultat == 1) {
                echo "<center>".$this->Html->link('Refaire un test', ['controller' => 'depistages',
                'action' => 'adolescent',
                'full_base' => true,],
                ['class' => "button small"]
                ) ."</center>";
