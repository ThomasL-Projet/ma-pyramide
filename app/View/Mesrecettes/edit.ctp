<?php
// titre de la page
$this->assign('title', 'Ma Pyramide Santé - Editer une recette');
...
$this->end();
?>﻿<noscript>
Cette page requiert que javascript soit activé.<br>

S'il vous plaît, veuillez activer javascript.<br><br>
</noscript>
<nav class="breadcrumbs" role="menubar" aria-label="breadcrumbs">
    ...
    <li role="menuitem" class="current"><?php echo $this->Html->link('Modification d\'une recette', 'Javascript:void(0);'); ?></li>
</nav>
<?php
...
<div id="presentation">
    <div class="row">
        <div class="small-12 small-centered columns">
            <div class="title-area"> Modification d'une recette</div> 
    ...
    <div class="row">
        <div class="small-12 columns">
            ...
            <?php else : ?>
                <div id="bloc-editeur">
                    <h1 align="center">Recette "<?php echo $recette['Mesrecette']['nom']; ?>"</h1><br /><br />
                    <form> 
                        <div class="row">
                            <div class="large-12 columns">
                                <label><div style="margin-bottom:-30px;"><p> Nom de la recette :</p></div>
                                    <input style="margin-left:220px" type="text" maxlength="50" id="saisie1" value="<?php echo $recette['Mesrecette']['nom']; ?>" required="required" name="data[Mesrecette][nom]" />
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="large-12 columns">
                                <label>
                                    <div style="margin-bottom:-30px;"><p> Type de recette :</p></div>
                                    <select name="data[Mesrecette][type_id]" style="margin-left:220px">
                                        <?php
                                        foreach ($fams as $famille) {
                                            if ($recette['Mesrecette']['type_id'] == $famille['id']) {
                        ...
                        <div class="row">
                            <div class="large-12 columns">
                                <label>
                                    <div style="margin-bottom:-30px; width:530px"><p> Description :</p></div>
                                    <textarea style="margin-left:220px; width:530px" id="saisie2" rows="6" cols="70" name="data[Mesrecette][description]" title="La description doit faire entre 1 et 500 caractètres" maxlength="500"><?php echo $recette['Mesrecette']['description']; ?></textarea>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="large-12 columns">
                                <label>
                                    <div style="margin-bottom:-30px;"><p> Temps de cuisson (en min) :</p></div>
                                    <input style="margin-left:220px " id="saisie3" type="text" maxlength="3" value="<?php echo $recette['Mesrecette']['temps_cui']; ?>" name="data[Mesrecette][temps_cui]" />
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="large-12 columns">
                                <label>
                                    <div style="margin-bottom:-30px;"><p> Temps de préparation (en min) :</p></div>
                                    <input style="margin-left:220px" id="saisie4" type="text" maxlength="3" value="<?php echo $recette['Mesrecette']['temps_prepa']; ?>" name="data[Mesrecette][temps_prepa]" />
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="large-12 columns">
                                <label>
                                    <div style="margin-bottom:-30px;"><p> Nombre de portions :</p></div>
                                    <select name="data[Mesrecette][quantite]" style="margin-left:220px">
                                        <?php
                                        if ($recette['Mesrecette']['quantite'] == 0.5) {
                                        ...
                                        } elseif ($recette['Mesrecette']['quantite'] == 1) {
                                            ...
                                            echo "<option value='3.5'>3 &frac12;</option>";
                                            echo "<option value='4'>4</option>";
                                        } elseif ($recette['Mesrecette']['quantite'] == 2) {
                                            echo "<option value='0.5'>&frac12;</option>";
                                            echo "<option value='1'>1</option>";
                                            echo "<option value='1.5' >1 &frac12;</option>";
                                            ...
                                            echo "<option value='3.5'>3 &frac12;</option>";
                                            echo "<option value='4'>4</option>";
                                        } elseif ($recette['Mesrecette']['quantite'] == 3) {
                                            echo "<option value='0.5'>&frac12;</option>";
                                            echo "<option value='1'>1</option>";
                                            echo "<option value='1.5' >1 &frac12;</option>";
                                            echo "<option value='2'>2</option>";
                                        ...
                                        ?>
                                        <center><div style="color:red;font-style:italic;"><p>Vous devez remplir les champs précédents avant d'ajouter des ingrédients ou des modes de préparation.</p></div><br /></center><hr />
                                    </select>                   
                                </label>
                            </div>
                        </div>        
                    ...
                    foreach ($aliments as $aliment) {
                        echo '<div id="ingred' . $i . '">';
                        if (strlen($aliment['aliment']['Alimentsdetaille']['nom']) > 60) {
                            echo "<div style=\"margin-left:220px\"> &bull; Nom : " . substr($aliment['aliment']['Alimentsdetaille']['nom'], 0, 57) . "...</div>";
                        } else {
                            echo "<div style=\"margin-left:220px\"> &bull; Nom : " . $aliment['aliment']['Alimentsdetaille']['nom'] . "</div>";
                        }
                        echo "<div style=\"margin-left:220px\"> &nbsp;&nbsp;Nom Portion : " . rech_portion($aliment['aliment']['Aliment'], $aliment['portion']) . "</div>";
                        echo "<div style=\"margin-left:220px\"> &nbsp;&nbsp; Quantite : " . $aliment['quantite'] . "</div>";
                        echo '<input class="valeurs' . $i . '" type="hidden" name="Ingred[' . $i . ']" value="' . $aliment['aliment']['Aliment']['id'] . '@' . $aliment['portion'] . '@' . $aliment['quantite'] . '" />';

                        echo $this->Html->link($this->Html->image('DeleteUser.png', array('style' => 'margin-left:60px; margin-bottom:40px;margin-top:-40px')), 'javascript:void(0)', array('onclick' => 'supprimeElement(' . $i . ',\'' . addslashes($aliment['aliment']['Alimentsdetaille']['nom']) . '\')', 'escape' => false));
                    ...
                    ?>
                    <a href="#top2"><button class="button small" style="margin:0px; width:180px; margin-left:220px" type="button" id="ajoutali">Ajouter des ingrédients </button></a><br><br><br>
                    <hr />
                    ...
                    <hr />
                    <br /><br />
                    <input style="margin:0px;alter:left; width:180px; margin-left:70px" type="submit" id="endform" name="endform" value="Modifier la recette" onclick="return validForm();" /><br>
                    ...
                    <?php echo $this->Html->link('<button style="margin:0px; margin-top:-30px; margin-left:490px; width:180px" class="button" type="button">Annuler </button>', '/mesrecettes', array('escape' => false)); ?>
                </div>
    ...
    <?php endif; ?>
        ...
        function resultatsub(id) {
            document.forms['MesrecetteEditForm'].postresult.value = id;
            document.forms['MesrecetteEditForm'].submit();
        }
        ...
        function supprimeMode(id, nom) {
            if (confirm("Confirmez-vous de vouloir supprimer le mode de préparation " + nom + " ?")) {
                var i;
                $(".modes" + id).remove();
                var nb_modes = <?php echo count($recette['Modespreparation']); ?>;
        ...
        function resetChamps() {
            if (confirm("Confirmez-vous de vouloir réinitialiser les champs ? Les aliments et modes de préparation ne seront pas supprimés.")) {
                ...
                document.getElementById("saisie3").value = "";
        ...
        function validForm() {
            ...
            if (!(regex.test(document.getElementById("saisie4").value))) {
