...
<div id="bloc-editeur">
	<h1 align="center">Nouvelle recette</h1><br /><br />
	<div style="margin-bottom:-30px;"><p> Nom de la recette :</p></div>
	<input style="margin-left:220px" type="text" maxlength="50" id="saisie1" required="required"  value="<?php if (isset($recette['Mesrecette']['nom'])) echo $recette['Mesrecette']['nom']; ?>" name="data[Mesrecette][nom]" /><br><br><br>
	...
	<textarea style="margin-left:220px; width:530px" id="saisie2" rows="6" cols="70" name="data[Mesrecette][description]" title="La description doit faire entre 1 et 500 caractètres" maxlength="500"><?php if (isset($recette['Mesrecette']['description'])) echo $recette['Mesrecette']['description']; ?></textarea><br><br><br>
	<div style="margin-bottom:-30px;"><p> Temps de cuisson (en min) :</p></div>
	<input style="margin-left:220px" id="saisie3" type="text" maxlength="3" name="data[Mesrecette][temps_cui]" value="<?php if(isset($recette['Mesrecette']['temps_cui'])) echo $recette['Mesrecette']['temps_cui']; ?>" /><br><br><br>
	<div style="margin-bottom:-30px;"><p> Temps de préparation (en min) :</p></div>
	<input style="margin-left:220px" id="saisie4" type="text" maxlength="3" value="<?php if (isset($recette['Mesrecette']['temps_prepa'])) echo $recette['Mesrecette']['temps_prepa']; ?>" name="data[Mesrecette][temps_prepa]" /><br><br><br>
