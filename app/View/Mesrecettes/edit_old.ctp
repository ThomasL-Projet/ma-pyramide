...
<div id="bloc-editeur">
	...
	<div style="margin-bottom:-30px;"><p> Nom de la recette :</p></div>
	<input style="margin-left:220px" type="text" maxlength="50" id="saisie1" value="<?php echo $recette['Mesrecette']['nom']; ?>" required="required" name="data[Mesrecette][nom]" /><br><br><br>
	...
	<textarea style="margin-left:220px; width:530px" id="saisie2" rows="6" cols="70" name="data[Mesrecette][description]" title="La description doit faire entre 1 et 500 caractètres" maxlength="500"><?php echo $recette['Mesrecette']['description']; ?></textarea><br><br><br>
	<div style="margin-bottom:-30px;"><p> Temps de cuisson (en min) :</p></div>
	<input style="margin-left:220px" id="saisie3" type="text" maxlength="3" value="<?php echo $recette['Mesrecette']['temps_cui']; ?>" name="data[Mesrecette][temps_cui]" /><br><br><br>
	<div style="margin-bottom:-30px;"><p> Temps de préparation (en min) :</p></div>
	<input style="margin-left:220px" id="saisie4" type="text" maxlength="3" value="<?php echo $recette['Mesrecette']['temps_prepa']; ?>" name="data[Mesrecette][temps_prepa]" /><br><br><br>
	...
	<select name="data[Mesrecette][quantite]" style="margin-left:220px">
		...
		?>
	</select><br><br><br><center><div style="color:red;font-style:italic;"><p>Vous devez remplir les champs précédents avant d'ajouter des ingrédients ou des modes de préparation.</p></div><br /></center><hr />
	<p> Ingrédients :</p> 
...
<div id ="validation">
	...
	<div id="cache" style="height: 400px;overflow: scroll;">
		...
		foreach ($nutriments as $nut) {
			$i++;
			if ($nut['valeur'] == 0 OR $i == 1) continue;
			echo '<tr>';
							...
							<td>  
								<ul>
									...
									<li>
										<p class='groupeAlimentaire'>
											<?php 
												/* ND*/ if(isset($obEnKcal)) echo 'Non définie';
											?> 
										</p>
									</li>
							...
							<td> 
						    	<ul>
						    		<li>
						    			<p class='groupeAlimentaire'>
						    				<?php 
												if (isset($obVitA)) echo round((($aliment1['Donneesaliment'][41]['valmoy'] * $quantiteAliment1 * $quantitePortion1 / 100)/$obVitA)*100,2). ' %';
											?> 
						    			</p>
						    		</li>
									<li>
	...
	function supprimeMode(id, nom) {
		if (confirm("Confirmez-vous de vouloir supprimer le mode de préparation " +nom+ " ?")) {
			...
			for (i = 1; i <= ( nb_modes); i = i+1) {
				if (document.getElementById("mode" +(i-1)).style.display == "none") continue;
