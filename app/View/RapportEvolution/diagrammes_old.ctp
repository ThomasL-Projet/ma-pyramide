...
<?php echo $this->Html->link('<< Retour', '/rapportEvolution/index/');?>
    ...
    <div class="texte">
		<div class="span3"> Diagrammes </div>
		<div class="p1"> Ces graphes résument un historique des tendances : poids, calories, groupes alimentaires et nutriments<br><br>
		Les <strong>lignes horizontales vertes</strong> représentent les valeurs que vous devez normalement atteindre mais ne pas dépasser
		</div> 			
	</div>
