<?php
// titre de la page
$this->assign('title', 'Ma Pyramide Santé - Ajouter un lien ');
...
<div class="row presentation">
    ...
    <div class="small-12 columns">
        ...
        <div class="small-12 columns">
            <h1 class="title text-center"> Ajouter un lien </h1> 
        </div>
        <div class="row">
            <div class="small-6 columns">
                ...
                <div class="input text">
                    <input name="data[Lien][title]" maxlength="150" type="text" id="LienTitle" class="input-medium" required="required"/>
                </div>
            </div>
            <div class="small-6 columns">
        ...
        <div class="small-12 columns">
            <div class="textarea">
                ...
                <textarea name="data[Lien][content]" id="LienContent"></textarea>  
