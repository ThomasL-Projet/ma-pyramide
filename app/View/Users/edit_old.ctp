<div id="presentation">
    <?php echo $this->Html->link('<< Retour', '/users/'); ?>
    ...
    <?php if (!(AuthComponent::user('role') == 'administrateur' && AuthComponent::user('id') != $this->request->data['User']['id'])) : ?>
        ...
        <div class="span2"> Modifiez votre profil </div> 
        <div class="bloc1">	
            ...
            <input type="text" name="data[User][datenaissance]" id="UserDatenaissance" onchange ="verifage()" value="<?php echo $datenaissance; ?>" <?php if ($age >= 0 AND $age < 18) echo 'disabled="disabled"'; ?> required="required"/><br><br><br>
            ...
            <?php if ($parent != null): ?>
                ...
                <input type="text" maxlength="50" id="Userparent" value="<?php echo $parent; ?>" disabled="disabled" /> <br><br>
            ...
            <input type="text" name="data[User][poids]" id="UserPoids" value="<?php echo intval($poids); ?>" required="required"/> </br></br></br>
            <div id="cache6">
