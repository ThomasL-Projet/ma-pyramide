        ...
        <div class="small-12 columns">
            ...
            <?php if (AuthComponent::user('id') == NULL): ?>
                ...
                <div class="small-12 small-centered columns">	
                    <ul class="tabs" data-tab small-centered columns>
                        <li class="tab-title active"><a href="#panel1"><strong>Etape 1 : Mon compte </strong></a></li>
                        <li class="tab-title"><a href="#panel2">Etape 2 : Mes données physiques </a></li>
                        <li class="tab-title"><a href="#panel3">Etape 3 : Mes données médicales</a></li>
                    </ul>
                            ...
                            <div class="row" data-equalizer>
                                <div class="small-8 small-centered columns panel" >
                                    ...
                                    <div class="small-7 columns" data-equalizer-watch>
                                        ...
                                        <input type="text" placeholder="Identifiant *" name="data[User][username]" maxlength="50" type="text" value="<?php if ($username != null) echo $username; ?>" id="UserUsername" required="required" title="Votre nom d'utilisateur doit faire entre 5 et 20 caractètres"/>
                                        ...
                                        <label for="UserPasswordConfirmation"></label>
                                        ...
                                        <input type="email" placeholder="E-mail *" name="data[User][email]" id="UserEmail" value="<?php if ($email != null) echo $email; ?>" /> 


                                        <label for="UserDatenaissance"></label>
                                        <input type="text" placeholder="Date de naissance *" name="data[User][datenaissance]" id="UserDatenaissance" value="<?php if ($datenaissance != null) echo $datenaissance; ?>" onchange ="verifage()" required="required"/>

                                        <label for="UserSexe">Sexe <em> *</em></label>
                                    ...
                                    <div class="small-12 columns" >
                                        <p>J'ai lu et approuvé les <strong><a href="#" data-reveal-id="myModal">conditions d'utilisations  </a></strong>  de MaPyramide.fr </p>
                                        ...
                                        <div id="myModal" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
                                            <div class="small-12 columns panel" style=" height: 400px; overflow-y: scroll">
                                                ...
                                                <p>TOUTE UTILISATION DES PAGES DU SITE WEB «  MA PYRAMIDE ALIMENTAIRE »
                                        ...
                                        <div id="cache0">
                                            ...
                                            <input type="text" name="data[User][parent]" maxlength="50" type="text" id="Userparent" /> 
                                        </div>
                                        ...
                                        <div id="cache">
                                            <div id="cache1">
                                                ...
                                                <input type="radio" name="data[User][enceinte]" id="pas_enceinte" value="N" onClick="traitenceinte();" ><a class='labelInscription'> Non </a>
                                            </div>

                                            <!-- Affiche si clic sur oui -->
                                            <div id="cache2">
                                                <label for="UserMoisEnceinte"> Depuis combien de mois ? <em> *</em> </label>
                                                <input type="text" name="data[User][nbmoisenceinte]" maxlength="50" type="text" id="UserMoisEnceinte" title="Indiquez le nombre de mois depuis que vous êtes enceinte"/> 

                                                <!-- Si clic sur non, demande Allaitante -->
                                                <label for="UserAllaitante"> Allaitante <em> *</em> </label>
                                                <input type="radio" name="data[User][allaitante]" id="allaitante" value="O" onClick="traitallaitante();"><a class='labelInscription'> Oui</a>
                                                <input type="radio" name="data[User][allaitante]" id="pas_allaitante" value="N" onClick="traitallaitante();"><a class='labelInscription'> Non</a>


                                                <label for="UserMoisAllaitante"> Depuis combien de mois ? <em> *</em> </label>
                                                <input type="text" name="data[User][nbmoisallaitante]" maxlength="50" type="text" id="UserMoisAllaitante" title="Indiquez le nombre de mois depuis que vous êtes allaitante"/>
                                            </div>
                                        </div>
                                    ...
                                    <br><br>
                                    <div class="small-12 small-text-right columns ">
                                        <input class="button" type="submit" value="Suivant" onClick="#panel3"/>
                                    </div>
                                    <br><br><br><br>
                            ...
                            <div class="row" data-equalizer>
                                <div class="small-8 small-centered columns panel" >
                                    ...
                                    <div class="small-7 columns" data-equalizer-watch>
                                        ...
                                        <label for="UserTaille"></label> 
                                        <input type="text" placeholder="Votre taille *" name="data[User][taille]" value="<?php if ($taille != null) echo $taille; ?>" id="UserTaille" required="required"/> 

                                        <label for="UserPoids"></label> 
                                        <input type="text" placeholder="Votre poids *" name="data[User][poids]" value="<?php if ($poids != null) echo $poids; ?>" id="UserPoids" required="required"/> 
                        ...
                        <div class="content" id="panel3" >
                            <div class="row">
                                <div class="small-12 panel">
                                    <h2>Mes données médicales </h2><br>
